...
export default function DemoDashboard() {
  ...
  return (
    <main className="shell">
      ...
      <section className="workspace" id="dashboard"><div className="panel" style={{ marginBottom: 18 }}><strong>Demo presentation data</strong><p style={{ marginBottom: 0, color: "#64748b" }}>Authentication, tenancy, and permissions are live foundation behavior. Student records on this screen remain demo-only until Phase 2 connects the CRM data layer.</p></div>
